...
# Streamlit App image
st.image("image/screenshot.png", caption='Think Game Prediction, Think Collins App', width=600, use_column_width="always")
# Streamlit App
...
def predict_outcome(team1, team2, date, data, model):
    ...
    if new_game.empty:
        st.error(f"Please, go back and select correct Home and Away Team. Also, ensure you chosose date after 2019 b/4 predicting")
        return None, None
